...
const queryAddNewSchedule = require('../../database/queries/schedule/add_new_schedule');
const {queryCheckExistingSchedule, queryCheckSameTimeInAnotherPlace} = require('../../database/queries/schedule/check_schedule');
